...
export const FullArrowRightIcon = ({ width, height, color }: Props) => (
  <svg width={width} height={height} fill={color} viewBox="0 0 14 11">
    <path
...
export const ShareIcon = ({ width, height, color }: Props) => (
  <svg width={width} height={height} viewBox="0 0 50 50" stroke={color}>
